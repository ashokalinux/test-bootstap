module "bootstrap" {
  ...
  tags = {
    ...
    "VantaOwner":  "judit.molnar@modusbox.com", 
    "VantaNonProd": "true",
    "VantaDescription": "RWANDA-Switch-tenancy",
    "VantaContainsUserData": "false",
    "VantaUserDataStored": "none",
    "VantaNoAlert": "rwanda-tenancy",
    "MBoxProject":  "afr-rswitch-rwanda",
    "MBoxOwner": "judit.molnar@modusbox.com",
    "MBoxCostCenter": "customer",
    "MBoxCustomer": "afr-rswitch-rwanda",
    "hibernation":  "no",
    "mojaloop/cost_center":  "oss-rwanda-sbx",
    "mojaloop/owner": "mbox-judit",

    "Tenant" = "mlf-rw" # The Tenant name (probably the name of the customer - this should be the same as the 'tenant' below)
  }

  domain       = "rwandalab.io" # The FQDN of the tenant
  tenant       = "mlf-rw"             # The Tenant name (probably the name of the customer - this should be the same as ths "tenant" above)
  region       = "ap-south-1"         # https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#concepts-available-regions
  environments = ["dev","sbx"]             # Comma Separated list of environments in this tenant.    e.g. ["dev","qa","test1"]
